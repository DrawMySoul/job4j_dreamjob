...
class VacancyControllerTest {
    ...
    @Test
    void whenRequestVacancyPageThenGetVacancyPage() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
    ...
    @Test
    void whenRequestWrongVacancyPageThenGetErrorPageWithMessage() {
    ...
    @Test
    void whenUpdateVacancyThenSameDataAndRedirectToVacanciesPage() throws Exception {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var vacancyArgumentCaptor = ArgumentCaptor.forClass(Vacancy.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    @Test
    void whenUpdateWrongVacancyThenGetErrorPageWithMessage() {
        var expectedException = new RuntimeException("Вакансия с указанным идентификатором не найдена");
    ...
    @Test
    void whenDeleteVacancyThenRedirectToVacanciesPage() {
    ...
    @Test
    void whenDeleteWrongVacancyThenGetErrorPageWithMessage() {
        var expectedException = new RuntimeException("Вакансия с указанным идентификатором не найдена");
