...
class CandidateControllerTest {
    ...
    void whenRequestCandidateListPageThenGetPageWithCandidates() {
        ...
        var candidate2 = new Candidate(1, "test1", "desc1", now(), 1, 2);
    ...
    @Test
    void whenRequestCandidatePageThenGetCandidatePage() {
        var candidate = new Candidate(1, "test1", "desc1", now(), 1, 2);
    ...
    @Test
    void whenRequestWrongCandidatePageThenGetErrorPageWithMessage() {
    ...
    @Test
    void whenUpdateCandidateThenSameDataAndRedirectToVacanciesPage() throws Exception {
        var candidate = new Candidate(1, "test1", "desc1", now(), 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var candidateArgumentCaptor = ArgumentCaptor.forClass(Candidate.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    @Test
    void whenUpdateWrongCandidateThenGetErrorPageWithMessage() {
        var expectedException = new RuntimeException("Вакансия с указанным идентификатором не найдена");
    ...
    @Test
    void whenSomeExceptionThrownWhileUpdateThenGetErrorPageWithMessage() {
        var expectedException = new RuntimeException("Failed to write file");
    ...
    @Test
    void whenDeleteCandidateThenRedirectToCandidatePage() {
    ...
    @Test
    void whenDeleteWrongCandidateThenGetErrorPageWithMessage() {
        var expectedException = new RuntimeException("Вакансия с указанным идентификатором не найдена");
